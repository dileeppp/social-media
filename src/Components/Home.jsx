...
import { Delete, Favorite, FavoriteBorder,Bookmark,BookmarkBorder } from "@mui/icons-material";
...
const Home = () => {
  ...
  return (
    <>
      <Box width="60%" position='absolute' marginLeft='20%' >
        {posts.length ? (
          posts.map((post) => (
            <Card elevation={1} open={isdelete}>
              <CardHeader
                avatar={
                ...
                action={
                  <IconButton color='warning' onClick={()=>setIsDelete(isdelete-1)}>
                    <Delete />
                  </IconButton>
                }
                id={post.id}
              ...
              <CardContent>
                <Typography variant="body2" color="text.secondary">
                  ...
                  Temporibus autem quasi totam, dolor doloribus saepe facilis,
                  soluta omnis alias excepturi facere aperiam porro! Voluptate
                  repellendus eos delectus, officiis voluptas exercitationem?
                </Typography>
              </CardContent>
              <Checkbox
                icon={<FavoriteBorder />}
